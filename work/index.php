...
<main class="min-h-screen bg-[#111112] text-[#F1F5FB]">
    ...
    <section class="px-4 md:px-15 pt-32 md:pt-96 mb-12 md:mb-10">
        <div class="grid grid-cols-1 md:grid-cols-2">
            <div class="col-span-1">
                <h1 class="font-[600] text-[40px] md:text-[56px] leading-[48px] md:leading-[64px] tracking-[-2%] mb-5 md:max-w-[95%]">What I’ve been working on lately for clients</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            <a href="/projects/crm" class="col-span-1 border-y border-[#2A2A2C] md:border-none py-4 md:py-0 group block">
                <img src="/public/images/my_projects_crm.png" alt="CRM" class="w-full object-contain mb-7">
                    ...
                    <h2 class="font-[600] text-[#F1F5FB]">CRM Web App <span class="text-[#9AA0A8] font-[600] inline md:hidden md:group-hover:inline">• Manage projects, clients, and communication in one system for agencies.</span></h2>
                    </div>
            ...
            <a href="/projects/illu" class="col-span-1 border-b border-[#2A2A2C] md:border-none pb-4 md:py-0 group block">
                ...
                <div class="flex items-center gap-2 flex-wrap text-[20px] md:text-[32px] leading-[24px] md:leading-[40px] tracking-[-2%] mb-7">
                    <h2 class="font-[600] text-[#F1F5FB]">Illu <span class="text-[#9AA0A8] font-[600] inline md:hidden md:group-hover:inline">• A high-performance eCommerce platform designed to balance a minimalist aesthetic with aggressive conversion-driven features.</span></h2>
                </div>
                <div class="flex gap-3 md:gap-4 flex-wrap text-[16px] md:text-[20px] md:opacity-0 md:max-h-0 overflow-hidden md:group-hover:opacity-100 md:group-hover:max-h-[200px] transition-all duration-500 ease-in-out">
                    <div class="bg-[#1D1E21] rounded-full text-[#F1F5FB] px-4 py-2">
            ...
            <a href="/projects/puff-n-stuff" class="col-span-1 border-b border-[#2A2A2C] md:border-none pb-4 md:py-0 group block">
                ...
                <div class="flex items-center gap-2 flex-wrap text-[20px] md:text-[32px] leading-[24px] md:leading-[40px] tracking-[-2%] mb-7">
                    <h2 class="font-[600] text-[#F1F5FB]">Puff n Stuff <span class="text-[#9AA0A8] font-[600] inline md:hidden md:group-hover:inline">• Puff 'n Stuff is a premier US catering leader for large-scale corporate and wedding events.</span></h2>
                </div>
                <div class="flex gap-3 md:gap-4 flex-wrap text-[16px] md:text-[20px] md:opacity-0 md:max-h-0 overflow-hidden md:group-hover:opacity-100 md:group-hover:max-h-[200px] transition-all duration-500 ease-in-out">
                    <div class="bg-[#1D1E21] rounded-full text-[#F1F5FB] px-4 py-2">
                        Platform Redesign
            ...
            <a href="/projects/kutura" class="col-span-1 border-b border-[#2A2A2C] md:border-none pb-4 md:py-0 group block">
                ...
                <div class="flex items-center gap-2 flex-wrap text-[20px] md:text-[32px] leading-[24px] md:leading-[40px] tracking-[-2%] mb-7">
                    <h2 class="font-[600] text-[#F1F5FB]">Kutura <span class="text-[#9AA0A8] font-[600] inline md:hidden md:group-hover:inline">• Kutura is a high-energy digital academy that fast-tracks young creatives into careers in design, marketing, and development.</span></h2>
                </div>
                <div class="flex gap-3 md:gap-4 flex-wrap text-[16px] md:text-[20px] md:opacity-0 md:max-h-0 overflow-hidden md:group-hover:opacity-100 md:group-hover:max-h-[200px] transition-all duration-500 ease-in-out">
                    <div class="bg-[#1D1E21] rounded-full text-[#F1F5FB] px-4 py-2">
                        Brand Identity
            ...
            <a href="/projects/machsfive" class="col-span-1 border-b border-[#2A2A2C] md:border-none pb-4 md:py-0 group block">
                ...
                <div class="flex items-center gap-2 flex-wrap text-[20px] md:text-[32px] leading-[24px] md:leading-[40px] tracking-[-2%] mb-7">
                    <h2 class="font-[600] text-[#F1F5FB]">Machsfive <span class="text-[#9AA0A8] font-[600] inline md:hidden md:group-hover:inline">• Machsfive is a minimalist portfolio designed for a contemporary artist to showcase evocative, expressionist works.</span></h2>
                </div>
                <div class="flex gap-3 md:gap-4 flex-wrap text-[16px] md:text-[20px] md:opacity-0 md:max-h-0 overflow-hidden md:group-hover:opacity-100 md:group-hover:max-h-[200px] transition-all duration-500 ease-in-out">
                    <div class="bg-[#1D1E21] rounded-full text-[#F1F5FB] px-4 py-2">
            ...
            <a href="/projects/lean-logic" class="col-span-1 border-b border-[#2A2A2C] md:border-none pb-4 md:py-0 group block">
                ...
                <div class="flex items-center gap-2 flex-wrap text-[20px] md:text-[32px] leading-[24px] md:leading-[40px] tracking-[-2%] mb-7">
                    <h2 class="font-[600] text-[#F1F5FB]">Lean Logic <span class="text-[#9AA0A8] font-[600] inline md:hidden md:group-hover:inline">• Lean Logic is a high-performance platform bridging B2B consulting with a proprietary SaaS app.</span></h2>
                </div>
                <div class="flex gap-3 md:gap-4 flex-wrap text-[16px] md:text-[20px] md:opacity-0 md:max-h-0 overflow-hidden md:group-hover:opacity-100 md:group-hover:max-h-[200px] transition-all duration-500 ease-in-out">
                    <div class="bg-[#1D1E21] rounded-full text-[#F1F5FB] px-4 py-2">
                        B2B Architecture
    ...
    <section>
        <div class="flex justify-between items-end mb-8 px-4 md:px-15">
            <div>
                <h3 class="font-[600] text-[#F1F5FB] text-[40px] md:text-[56px] leading-[48px] md:leading-[64px] tracking-[-2%] mb-5">Additional Projects</h3>
        ...
        <div class="flex flex-col">
            <a href="https://internationalvanlines.com/" target="_blank" class="group relative border-b border-[#2A2A2C] px-4 md:px-15 py-5 md:py-10 flex justify-between items-center transition-colors duration-500">
                ...
                <p class="text-[20px] md:text-[32px] text-[#F1F5FB] md:text-[#9AA0A8] leading-[24px] md:leading-[40px] font-[600] group-hover:text-[#F1F5FB] transition-colors duration-300 relative z-40">• International Van Lines</p>
            ...
            <a href="https://copperleafcabinets.com/" target="_blank" class="group relative border-b border-[#2A2A2C] px-4 md:px-15 py-5 md:py-10 flex justify-between items-center transition-colors duration-500">
                <div class="absolute inset-0 bg-gradient-to-b from-[#2A2A2C]/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none"></div>
                <p class="text-[20px] md:text-[32px] text-[#F1F5FB] md:text-[#9AA0A8] leading-[24px] md:leading-[40px] font-[600] group-hover:text-[#F1F5FB] transition-colors duration-300 relative z-40">• Copper Leaf</p>
                <div class="relative z-10 w-[172px] h-[120px] md:h-full hidden md:flex items-start justify-end">
            ...
            <a href="https://stormblockers.com/" target="_blank" class="group relative border-b border-[#2A2A2C] px-4 md:px-15 py-5 md:py-10 flex justify-between items-center transition-colors duration-500">
                <div class="absolute inset-0 bg-gradient-to-b from-[#2A2A2C]/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none"></div>
                <p class="text-[20px] md:text-[32px] text-[#F1F5FB] md:text-[#9AA0A8] leading-[24px] md:leading-[40px] font-[600] group-hover:text-[#F1F5FB] transition-colors duration-300 relative z-40">• Storm Blockers</p>
                <div class="relative z-10 w-[172px] h-[120px] md:h-full hidden md:flex items-start justify-end">
            ...
            <a href="https://theartofderm.com/" target="_blank" class="group relative border-b border-[#2A2A2C] px-4 md:px-15 py-5 md:py-10 flex justify-between items-center transition-colors duration-500">
                <div class="absolute inset-0 bg-gradient-to-b from-[#2A2A2C]/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none"></div>
                <p class="text-[20px] md:text-[32px] text-[#F1F5FB] md:text-[#9AA0A8] leading-[24px] md:leading-[40px] font-[600] group-hover:text-[#F1F5FB] transition-colors duration-300 relative z-40">• Art of Dermatology</p>
                <div class="relative z-10 w-[172px] h-[120px] md:h-full hidden md:flex items-start justify-end">
            ...
            <a href="https://themosaicspa.com/" target="_blank" class="group relative border-b border-[#2A2A2C] px-4 md:px-15 py-5 md:py-10 flex justify-between items-center transition-colors duration-500">
                <div class="absolute inset-0 bg-gradient-to-b from-[#2A2A2C]/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none"></div>
                <p class="text-[20px] md:text-[32px] text-[#F1F5FB] md:text-[#9AA0A8] leading-[24px] md:leading-[40px] font-[600] group-hover:text-[#F1F5FB] transition-colors duration-300 relative z-40">• Mosaic Luxury Medical Spa</p>
                <div class="relative z-10 w-[172px] h-[120px] md:h-full hidden md:flex items-start justify-end">
