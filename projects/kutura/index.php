    ...
    <section class="grid grid-cols-1 md:grid-cols-3 px-4 md:px-15 py-6 md:py-8 gap-10 md:gap-14">
        <div class="col-span-1">
            <p class="text-[20px] md:text-[24px] leading-[24px] md:leading-[30px] font-[500] text-[#F1F5FB] mb-8 md:mb-36">
               Kutura is a high-impact digital academy. I led the end-to-end design, building a vibrant brand identity and a high-energy web experience engineered for young digital talent. 
            </p>
        ...
        <div class="col-span-1 md:col-span-2">
            ...
            <div id="project-text-container" class="relative max-h-[560px] overflow-hidden transition-all duration-500">
                <p class="text-[24px] md:text-[32px] leading-[30px] md:leading-[48px] font-[500] text-[#F1F5FB]">The primary challenge was to create an educational platform that felt energetic and modern rather than academic and dry. Targeting Gen Z and young adults required a "vibe-first" approach—merging high-end aesthetics with lightning-fast performance and intuitive navigation to capture and hold the attention of digital natives.
                    <br> 
                    <br>
                    I developed a bold, modern visual identity that reflects the "build skills that matter" ethos. By creating custom graphics and unique blog thumbnails, I ensured that every touchpoint of the brand felt cohesive and premium. This high level of visual polish leverages the Aesthetic-Usability Effect, instantly establishing Kutura as a professional authority in the design and tech space.
                    <br> 
                    <br>
                    Interactive Engagement (Micro-Interactions) To keep the experience engaging, I designed a suite of custom Micro-Interactions across the user flow. These subtle animations provide immediate feedback, satisfying the Doherty Threshold and making the act of exploring courses feel like a dynamic, tactile experience rather than a static browse.
                    <br> 
                    <br>
                    Cognitive Load Management Educational platforms often suffer from information overload. I applied the principle of Chunking to the program pages, breaking down complex course syllabi, pricing, and benefits into digestible, high-impact modules. This ensures that prospective students can quickly grasp the value of each accelerator program without feeling overwhelmed.
                    <br>
                    <br>
                    Social Proof and Peer Validation Recognizing the importance of community for this demographic, I designed dedicated sections for "Direct Employer Access" and "Student Networks." By highlighting the connection between education and real-world hiring (thrasker, Klarna, etc.), I built a "Trust Architecture" that bridges the gap between learning and career launching.
                    <br>
                    <br>
                    Mobile-Focused Navigation (Fitts’s Law) With the target audience predominantly using mobile devices for social discovery, I optimized the entire user flow for handheld use. Using Fitts’s Law, I placed the "Apply Now" and "Course Selection" actions in high-reach zones, ensuring a frictionless conversion path from the Instagram-to-Web journey.
                    <br>
                    <br>
                    To bring Kutura to life, I executed a multi-layered design strategy that unified brand identity with functional UX. I developed a Vibrant Brand System, selecting a typography and color palette specifically engineered to resonate with the energy and ambition of young creatives. This visual foundation was extended into a library of Custom Visual Assets, where I designed unique graphics and blog thumbnails to maintain absolute brand consistency across every digital touchpoint. Finally, I mapped a seamless End-to-End User Flow, ensuring that the transition from initial curiosity to final enrollment was frictionless. By combining these bespoke visuals with a logical navigation path, I created an ecosystem that feels both professional and highly relatable to the next generation of digital talent.
                    <br>
                    <br>
